                    ...
                    <div class="flex justify-between p-5 bg-indigo-800 border-b">
                        <div class="space-y-1">
                            ...
                            <div v-else>
                                ...
                                <p class="text-sm font-medium leading-5 text-gray-400">
                                    Create one or multiple employees with employee or admin roles</p>
                            </div>
                        </div>
                        <div>
                                ...
                                <div class="border border-gray-400 p-2 rounded grid divide-y divide-gray-400">
                                    <label class="flex items-start p-2">
                                        ...
                                        <div class="ml-3 text-gray-700 font-medium">
                                            <p>Employee</p>
                                            <small class="text-indigo-700">Can access the plugin</small>
                                        </div>
                                    </label>
...
export default {
    ...
    created() {
        this.eventHub.$on(eventNames.createEmployees, (employee) => {
