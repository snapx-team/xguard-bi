                                        ...
                                        <tr :key="employeeIndex">
                                            <td class="px-5 py-5 bg-white text-sm">
                                                <div class="flex items-center">
                                                    <avatar :name="employee.user.fullName" :size="6" class="mr-3"></avatar>
                                                    <div class="ml-3">
                                                        <p class="text-gray-900 whitespace-no-wrap">
                                                            {{ employee.user.fullName }} </p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="px-5 py-5 bg-white text-sm">
...
export default {
    ...
    computed: {
        filtered() {
            ...
            return this.employees.filter((e) => {
                ...
                return !this.filter || e.user.fullName.match(regex);
            });
        },
    },
    ...
    methods: {
        editEmployee(index) {
            this.eventHub.$emit("create-or-update-employees", this.filtered[index]);
        },
