    ...
    <div>
        <div class="flex" id="app">
            ...
            <div class="relative min-w-screen border-r flex-grow overflow-x-auto"
                 v-bind:class="{ 'overflow-hidden': XguardBusinessIntelligencePluginIsLoading }">
                <transition enter-active-class="transition duration-500 ease-out transform"
                    ...
                    <div class="z-50 overflow-auto h-screen absolute inset-0 bg-gray-400 bg-opacity-75 flex"
                         v-if="XguardBusinessIntelligencePluginIsLoading">
...
export default {
    ...
    data() {
        return {
            eventHub: new Vue(),
            XguardBusinessIntelligencePluginIsLoading: false,
        };
    },
    ...
    created() {
        this.eventHub.$on("set-loading-state", (state) => {
            this.XguardBusinessIntelligencePluginIsLoading = state;
        });
    },
